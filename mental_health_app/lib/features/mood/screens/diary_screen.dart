                ...
                children: [
                  ...
                  if (_fullMode) ...[
                    ...
                    SwitchListTile(
                      ...
                      subtitle: Text(
                        _structuredDay ? 'Не хаотичным' : 'Скорее хаотичным',
                      ),
                      onChanged: (value) {
                        setState(() {
                          _structuredDay = value;
                        });
                      },
                    ),
                  ],
